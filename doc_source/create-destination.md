# Select destination<a name="create-destination"></a>

This topic describes the **Select destination** page of the **Create Delivery Stream** wizard in Amazon Kinesis Data Firehose\.

Kinesis Data Firehose can send records to Amazon Simple Storage Service \(Amazon S3\), Amazon Redshift, Amazon Elasticsearch Service \(Amazon ES\), and any HTTP enpoint owned by you or any of your third\-party service providers, inlcuding Datadog, New Relic, and Splunk\.
